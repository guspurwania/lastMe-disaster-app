...
|--------------------------------------------------------------------------
*/
$config['qisqus']['end_point'] = 'https://testqisqus-stag.qiscus.com/api/v2/';
$config['qisqus']['sdk_secret'] = '854ad2ddd8bf369d42b9a41fd4c712a4';
...
|
*/
$config['rest_valid_logins'] = ['dokterchatid' => 'Menuju2018Cemerlang'];
